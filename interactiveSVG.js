    ...
    **************************************************/
    ...
    var InteractiveBezier = function(svgObject, attributes) {
        ...
        if (this.p4) {
            ...
            if (this.showHandles) {
                svgObject.addLine({ p1: this.p1, p2: this.p2, class: "line static-line handle" });
                svgObject.addLine({ p1: this.p3, p2: this.p4, class: "line static-line handle" });
            }
        } else {
            // Quadratic bezier
            this.addDependency(
            ...
            if (this.showHandles) {
                svgObject.addLine({ p1: this.p1, p2: this.p2, class: "handle" });
                svgObject.addLine({ p1: this.p2, p2: this.p3, class: "handle" });
            }
        }
